...
function __autoload($ClassName){
	...
	$operacion='modificar_contenidom';
	$palabra='Editar Contenido de Marca';
	$temporal = new contenidom(1);
	$temporal -> obtener_contenidom();
    $clave = 'ModContenidom';
?>
...
?>
	<title>Formulario de Contenido de Marca</title>
<?php
            ...
            <div class="page-content inset">
                <div class="row rowedit">
                    ...
                    <form id="form-validation" style="display: inline" name="form1" action="operaciones.php" method="post" onsubmit="return validar_campos()" enctype="multipart/form-data">
                    		<input type="hidden" name="id_nosotros" value="1"/>        
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                        <p>Esta sección es del video que se muestra en Contenido de Marca. Ingresa un link del video y selecciona si es de youtube o de vimeo para que podamos mostrar el video en la página web.</p>
                    	<div id="link" class="input-group espacios">
                        	<span class="input-group-addon es">Link Video</span>
                        	<input type="text"  name="link_video" class="form-control" placeholder="Ingrese el link aquí..." value="<?=$temporal->link_video?>">
                        </div>
                        <div id="tipo" class="input-group espacios">
...
?>
 ...
 <!--Script que sirve para validar-->
	...
	function validar_campos(){
        ...
        if(form1.link_video.value != ""){
            if (form1.link_video.value.length < 2 || !myRegExp.test(form1.link_video.value)){
           form1.link_video.focus();
