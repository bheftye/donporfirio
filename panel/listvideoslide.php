	...
	switch($success){
		...
		case '1':
			$alert = '<div class="alert alert-success alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha creado correctamente videoslide.
					  </div>';	
		break;
		case '2':
			$alert = '<div class="alert alert-success alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha modificado correctamente el videoslide.
					  </div>';	
		break;
		case '3':
			$alert = '<div class="alert alert-info alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha eliminado correctamente el(los) videoslide(s).
					  </div>';	
		break;
		case '4':
			$alert = '<div class="alert alert-info alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha activado correctamente el(los) videoslide(s).
					  </div>';	
		break;
		case '5':
			$alert = '<div class="alert alert-warning alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha desactivado correctamente el(los) videoslide(s).
					  </div>';	
		break;				
	}
}
...
$temporal = new video_slide();
$lista_video_slide = $temporal -> listar_videos_slide();
$clave='AgrVidSli';
$clave2='ElimVidSli';
$clave3='AcDcVidSli';
$clave4='SortTableVidSli';
$sort='video_slide';
$handle = "";
...
?>
	<title>Listado De Videoslides</title>
<?php
                ...
                <div class="row rowedit">
                   ...
                   <div class='notifications bottom-right'></div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <p class="titulo">Videoslides</p>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">                    	
                    	<form action="formvideoslide.php" method="post">
                    ...
                    <div class="styled-large">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <ul class="ulfiltros">
                                ...
                                <li class="lifiltros">    
                                    <button type="submit" class="buttonaplicar" name="operaciones" value="operavideoslide">Aplicar</button>
                                </li>
                          ...
                          <div class="busqueda espacios"><input type="search" data-column="all" class="form-control searchProy" placeholder="Buscar..." id="searchVideoSlide"/></div>                         
                        </div>
                    ...
                    <div class="styled-small">
                    	<div class="col-sm-12 col-xs-12">
                        	<div class="busqueda"><input type="search" data-column="all" class="form-control searchProy" placeholder="Buscar..." id="searchVideoSlideMovil"/></div> 
                        </div>
                    	<div class="col-sm-12 col-xs-12">
                            <ul class="ulfiltros">
                                <li class="lifiltros">
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive">
                          <table id="tableProy" class="table table-hover table-striped tablesorter">
                            <thead class="styled-thead">
                              <tr>
                                ...
                                <th>Título Video <i class="fa fa-sort"></i></th>
               	...
               	<?php
                 	foreach ($lista_video_slide as $elemento) {
                            ...
                            $class = 'nover';
        								...
        								if($elemento['status']!=0){      									
                          $img='img/invisible.png';
                          $funcion='Activar('.$elemento['id_video_slide'].')';
                          $class = 'ver';
        								}
        								else{
        							  		$img='img/visible.png';
                          $funcion='Desactivar('.$elemento['id_video_slide'].')';
                          $class = 'nover';
        							   }
      							}
						...
						echo  '<tr>
                              	<td>
                                  <input type="hidden" name="idorden" class="idorden" value="'.$elemento['id_video_slide'].'">
                                	<input type="checkbox" id="'.$elemento['id_video_slide'].'" name="id_video_slide[]" value="'.$elemento['id_video_slide'].'">
									<label for="'.$elemento['id_video_slide'].'"><span></span></label>
                                </td>                    
                                <td><a href="formvideoslide.php?id_video_slide='.$elemento['id_video_slide'].'">'.$elemento['titulo_video'].'</a></td>
                                ...
                                <td class="text-center visible-lg visible-md">'.$handle.'<img class="manita '.$class.'" onclick="'.$funcion.'" id="temp'.$elemento['id_video_slide'].'" src="'.$img.'"></td>
                              </tr>';
					}
         		?>	       
         					</form>                
