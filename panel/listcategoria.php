	...
	switch($success){
		...
		case '1':
			$alert = '<div class="alert alert-success alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha agregado correctamente la categoría.
					  </div>';	
		break;
		case '2':
			$alert = '<div class="alert alert-success alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha modificado correctamente la categoría.
					  </div>';	
		break;
		case '3':
			$alert = '<div class="alert alert-info alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha eliminado correctamente la(las) categoría(s).
					  </div>';	
		break;
		case '4':
			$alert = '<div class="alert alert-info alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha activado correctamente la(las) categoría(s).
					  </div>';	
		break;
		case '5':
			$alert = '<div class="alert alert-warning alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha desactivado correctamente la(las) categoría(s).
					  </div>';	
		break;				
	}
}
...
$lista_categorias = $temporal -> listar_categorias();
$clave='AgrCat';
$clave2='ElimCat';
$clave3='AcDcCat';
$clave4='SortTableCat';
                ...
                <div class="row rowedit">
               	...
               	<?php
                 	foreach ($lista_categorias as $elemento) {
                 			if($seguridad->valida_permiso_usuario($_SESSION['idusuario'],$clave3)==0){
								...
								if($elemento['status']!=1){
									...
									$class = 'nover';
							  		...
							  		$img='img/invisible.png';
									$funcion='Activar('.$elemento['id_categoria'].')';
									$class = 'ver';
							   }
							}
						...
						echo  '<tr>
                              	<td>
                                  <input type="hidden" name="idorden" class="idorden" value="'.$elemento['id_categoria'].'">
